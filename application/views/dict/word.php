<div class="w3-container">
    <div class="w3-left w3-margin-top w3-margin-left">
        ...
        <div>
            <?php if (isset($pre['id']) && $pre['id']>0) {echo anchor('dict/soz/'.$pre['id'].'/'.filter_url($pre['word']), $pre['word'],'class="w3-button  w3-gray"');} ?> < &nbsp;&nbsp;>
            <?php if (isset($next['id']) && $next['id']>0) {echo anchor('dict/soz/'.$next['id'].'/'.filter_url($next['word']), $next['word'],'class="w3-button  w3-gray"');} ?>
        </div>
