...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "../../../cssjs/openwysiwyg/images/";
		
		// Popups Directory
		this.PopupsDir = "../../../cssjs/openwysiwyg/popups/";
		
		// CSS Directory File
		this.CSSFile = "../../../cssjs/openwysiwyg/styles/wysiwyg.css";		
		...
		this.DefaultStyle = "font-family: Arial; font-size: 14px; background-color: #FFFFFF";
		
		// Stylesheet if editor is disabled
		this.DisabledStyle = "font-family: Arial; font-size: 14px; background-color: #EEEEEE";
